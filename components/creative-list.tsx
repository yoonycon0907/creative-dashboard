  ...
  return (
    <div className="w-full">
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        {/* Header */}
        <div className="grid grid-cols-12 gap-3 px-5 py-3 bg-gray-50 border-b border-gray-200 sticky top-0 z-10 text-xs font-semibold text-gray-600">
          <div className="col-span-3">소재</div>
          <div className="col-span-1 text-right">지출</div>
          <div className="col-span-1 text-right">ROAS</div>
          <div className="col-span-1 text-right">CPP</div>
          <div className="col-span-1 text-right">CTR</div>
          <div className="col-span-1 text-right">CPC</div>
          <div className="col-span-1 text-right">구매</div>
          <div className="col-span-1 text-right">노출</div>
        ...
        {creatives.map((creative) => (
          <div
            ...
            className="grid grid-cols-12 gap-3 px-5 py-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors last:border-b-0"
          >
            {/* Name & Tags */}
            ...
            <div className="col-span-1 text-right">
              <div className="text-sm text-gray-700">
                {formatCurrency(creative.total_impressions)}
              </div>
            </div>
